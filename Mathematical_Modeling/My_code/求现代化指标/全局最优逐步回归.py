...
def forward_stepwise_regression(X, y, k):
    ...
    selected_features = []
    residual_sum_of_squares = float('inf')
    ...
    for i in range(k):
        ...
        for feature in X.columns:
            ...
            rss = ((y - model.predict(X_selected)) ** 2).sum()
    ...
    return selected_features, residual_sum_of_squares
...
for i in range(1,6):
    a, b = forward_stepwise_regression(X, y, i)
    print(a,b)
    re(df[list(a)],y)
